...
% ((2+3)-4), 4 and ~((2*3)+(3*4)) which is fully bracketed and where you use a tilde (~) for unary minus.
...
% “then” value if the “if” expression evaluates to 0, and it is the “else” value otherwise.
- module(es2).
- export()